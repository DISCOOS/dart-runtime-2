...
description: A runtime generated by package:runtime_2
version: 1.0.0
...
import 'package:runtime_2/slow_coerce.dart' as runtime_cast;
$_directiveToken
...
class GeneratedContext extends RuntimeContext {
  ...
  String get loaderSource {
    return _loaderShell.replaceFirst(_directiveToken, _directives).replaceFirst(_assignmentToken, _assignments);
  }
